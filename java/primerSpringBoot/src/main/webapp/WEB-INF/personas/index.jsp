	...
	<script>
		...
		function eliminar(id) {
			Swal.fire({
				...
				if(res.value) {
					const url = 'http://localhost:8080/primer-spring/personas/'+id;
					console.log(url);
					$.ajax(url, {
						method: 'delete'
					}).then(resp => {
						if(resp) {
							window.location = "http://localhost:8080/primer-spring/personas/";
						}
